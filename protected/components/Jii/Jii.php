...
class Jii extends CComponent
{
	...
	{
		Yii::log('JII INIT', 'info', 'jii');
//		Yii::app()->onbeginRequest = array($this, 'mapController');
...
class JiiEvents 
{
	public static function mapController($event)
	{
		Yii::log('MAPPING CONTROLLERS');

		//Yii::log(print_r(Yii::app()->controllerMap, true), 'info', 'components.jii');
